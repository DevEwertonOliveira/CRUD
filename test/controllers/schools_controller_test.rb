...
class SchoolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school" do
    assert_difference('School.count') do
      post schools_url, params: { school: { email: @school.email, name: @school.name, phone: @school.phone } }
    end
  ...
  test "should update school" do
    patch school_url(@school), params: { school: { email: @school.email, name: @school.name, phone: @school.phone } }
